                ...
                if((df_next.values[i][0] == last_match_home_team.values[0][0]) &
                  (float(df_next.values[i][2]) <= 6) & (float(last_match_home_team.values[0][2]) <= 6) ):
                    ...
                    if(len(df_soccervista_predictions)==0):
                        ...
                        for i in df_next_method.index:
                            df_next_method.at[i,'Score_Home']=similar(df_next_method.values[i][0],df_next_method.values[i][8])
                            df_next_method.at[i,'Score_Away']=similar(df_next_method.values[i][1],df_next_method.values[i][9])
                            df_next_method.at[i,'Sum_Score']=df_next_method.at[i,'Score_Home']+df_next_method.at[i,'Score_Away']
                        ...
                        if(len(df_rankings)>0):
                            rank_arr_home=df_rankings[df_rankings["team"]==df_next_method.values[0][0]]
                            rank_arr_away=df_rankings[df_rankings["team"]==df_next_method.values[0][1]]
                        ...
                        Utility.build_bot_message(last_match_home_team.values[0], df_next_method.values[0], tip,rank_home,points_home,rank_away,points_away,number_of_teams)
                ...
                if((df_next.values[i][0] == last_match_home_team.values[0][1]) &
                   (float(df_next.values[i][2]) <= 6) & (float(last_match_home_team.values[0][4]) <= 6) ):
                    ...
                    if(len(df_soccervista_predictions)==0):
                        ...
                        tip='1X'
                        insertIntoNextMetodo( df_next.values[i], last_match_home_team.values[0][4], 0, last_match_home_team.values[0][8],diff_goals_home_team, tip)
                        ...
                        df_next_method=df_next_method.loc[[df_next_method['Sum_Score'].idxmax()]]
                        df_next_method['last_lost_odd'] = last_match_home_team.values[0][4]
                        df_next_method['last_lost_home'] = 0
                        df_next_method['last_competition_cod'] = last_match_home_team.values[0][8]
                        df_next_method['last_diff_goals'] = -diff_goals_home_team
                        df_next_method['tip'] = '1X'
                        df_next_method['flag'] = 0
                        ...
                        Utility.build_bot_message(last_match_home_team.values[0], df_next_method.values[0], tip,rank_home,points_home,rank_away,points_away,number_of_teams)
                        insertIntoNextMetodo( df_next_method.values[0], last_match_home_team.values[0][4], 1, last_match_home_team.values[0][8], diff_goals_home_team,tip)
            ...
            if(diff_goals_away_team>=3):
                ...
                if(( df_next.values[i][1] == last_match_away_team.values[0][0] ) &
                   ( float(df_next.values[i][4]) <= 6 ) & ( float(last_match_home_team.values[0][2]) <= 6 ) ):
                    ...
                    if(len(df_soccervista_predictions)==0):
                        Utility.build_bot_message_no_soccervista(last_match_home_team.values[0], df_next.values[0], tip)
                        #insertIntoNextMetodo( df_next.values[i], last_match_home_team.values[0][4], 1, last_match_home_team.values[0][8], diff_goals_home_team,tip)
                        ...
                        df_next_method=df_next_method.loc[[df_next_method['Sum_Score'].idxmax()]]
                        df_next_method['last_lost_odd'] = last_match_away_team.values[0][2]
                        df_next_method['last_lost_home'] = 1
                        df_next_method['last_competition_cod'] = last_match_away_team.values[0][8]
                        df_next_method['last_diff_goals'] = diff_goals_away_team
                        df_next_method['tip'] = 'X2'
                        df_next_method['flag'] = 0
                        df_next_method['home_goals']=None
                        df_next_method['away_goals']=None
                        tip='X2'
                        ...
                        Utility.build_bot_message(last_match_away_team.values[0],df_next_method.values[0],tip,rank_home,points_home,rank_away,points_away,number_of_teams)
                        insertIntoNextMetodo( df_next_method.values[0], last_match_away_team.values[0][2], 1, last_match_away_team.values[0][8],diff_goals_away_team, tip)
            #lost_home=false
                ...
                if(( df_next.values[i][1] == last_match_away_team.values[0][1] ) &
                    ...
                    if(len(df_soccervista_predictions)==0):
                        ...
                        df_next_method['last_lost_odd'] = last_match_away_team.values[0][4]
                        df_next_method['last_lost_home'] = 0
                        df_next_method['last_competition_cod'] = last_match_away_team.values[0][8]
                        df_next_method['last_diff_goals'] = -diff_goals_away_team
                        df_next_method['tip'] = 'X2'
                        ...
                        Utility.build_bot_message(last_match_away_team.values[0],df_next_method.values[0], tip,rank_home,points_home,rank_away,points_away,number_of_teams)
                        insertIntoNextMetodo( df_next_method.values[0], last_match_away_team.values[0][4], 0, last_match_away_team.values[0][8],diff_goals_away_team, tip)
    except:
        pass
